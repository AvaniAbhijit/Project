...
btn_sqrt = tk.Button(root, text='√', font=('Arial', 20), width=3, height=1, command=square_root)
btn_percentage = tk.Button(root, text='%', font=('Arial', 20), width=3, height=1, command=percentage)
btn_square = tk.Button(root, text='x^2', font=('Arial', 20), width=3, height=1, command=square)
...
btn_percentage.grid(row=5, column=2)
